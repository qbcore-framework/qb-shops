...
Config.Products = {
    ...
    ['weapons'] = {
        ...
        { name = 'weapon_pistol',       price = 5000, amount = 50, info = { attachments = { { component = 'COMPONENT_AT_PI_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_stungun',      price = 8000, amount = 50, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_pumpshotgun',  price = 8000, amount = 50, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_smg',          price = 8000, amount = 50, info = { attachments = { { component = 'COMPONENT_AT_SCOPE_MACRO_02', label = '1x Scope' }, { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' } } } },
        { name = 'weapon_carbinerifle', price = 8000, amount = 50, info = { attachments = { { component = 'COMPONENT_AT_AR_FLSH', label = 'Flashlight' }, { component = 'COMPONENT_AT_SCOPE_MEDIUM', label = '3x Scope' } } } },
        { name = 'weapon_nightstick',   price = 8000, amount = 50 },
        { name = 'weapon_flashlight',   price = 8000 , amount = 50 },
        { name = 'pistol_ammo',         price = 8000, amount = 50 },
        { name = 'smg_ammo',            price = 8000, amount = 50 },
        { name = 'shotgun_ammo',        price = 8000, amount = 50 },
        { name = 'rifle_ammo',          price = 8000, amount = 50 },
        { name = 'handcuffs',           price = 8000, amount = 50 },
        { name = 'armor',               price = 10000 , amount = 50 },
        { name = 'radio',               price = 3000, amount = 50 },
        { name = 'heavyarmor',          price = 50000, amount = 40 },
    },
    ['blackmarket'] = {
